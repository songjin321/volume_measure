...
def add_aruco_markers(sfm_filename):
    ...
    marker_info = {       
        ...
        'aruco_0':  (0.0, 0.0, 0.0),
        'aruco_1':  (0.0, 44.5, 0.0),
        'aruco_2':  (0.0, 89, 0.0),
        'aruco_3':  (0.0, 133.5, 0.0),

        'aruco_4':  (44.5, 0.0, 0.0),
        'aruco_5':  (44.5, 44.5, 0.0),
        'aruco_6':  (44.5, 89, 0.0),
        'aruco_7':  (44.5, 133.5, 0.0),

        'aruco_8':  (89, 0.0, 0.0),
        'aruco_9':  (89, 44.5, 0.0),
        'aruco_10': (89, 89, 0.0),
        'aruco_11': (89, 133.5, 0.0),

        'aruco_12': (133.5, 0.0, 0.0),
        'aruco_13': (133.5 ,44.5, 0.0),
        'aruco_14': (133.5, 89, 0.0),
        'aruco_15': (133.5, 133.5, 0.0),

        'aruco_16': (178, 0.0, 0.0),
        'aruco_17': (178, 44.5, 0.0),
        'aruco_18': (178 ,89, 0.0),
        'aruco_19': (178, 133.5, 0.0),
    }
